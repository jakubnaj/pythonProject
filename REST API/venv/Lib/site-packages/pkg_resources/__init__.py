...
class ResourceManager:
    ...
    def _warn_unsafe_extraction_path(path):
        ...
        if os.name == 'nt' and not path.startswith(os.environ['windir']):
            ...
            #  and temp directories are not writable by other users_dispatcher, so
            #  bypass the warning.
            return
...
# Silence the PEP440Warning by default, so that end users_dispatcher don't get hit by it
